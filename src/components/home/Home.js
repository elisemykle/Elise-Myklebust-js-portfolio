        ...
        <Container id="content">
          <Row>
            <Col xs="12" lg="6">
                ...
                <p className="home__text">This was our first exam assignment we got at school where we had our first real customer. There we created a new visual identity for the customer such as a website, logo and business card.</p>
            </Col>
                <Col xs="12" lg="6">
